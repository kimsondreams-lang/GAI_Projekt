...
export default function TaskDashboard({ compact = false }) {
  ...
  const autoBtnClass = autoRefresh ? "neo-btn neo-btn-primary" : "neo-btn";
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-neo-fg">{taskStats.total}</div>
        ...
        <div className="space-y-2">
          ...
          {loading ? (
            ...
            <div key={task.id} className="flex items-center justify-between p-3 neo-surface">
              <div className="flex items-center space-x-3">
                {getStatusIcon(task.status)}
                <div>
                  <div className="font-medium text-sm text-neo-fg">{task.title}</div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-neo-fg">Task Management</h2>
          <p className="text-neo-muted">Monitor and control autonomous tasks</p>
        </div>
      <div className="flex items-center space-x-4">
          <button
            onClick={() => setAutoRefresh(!autoRefresh)}
            className={autoBtnClass}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="neo-card p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-neo-fg">{taskStats.total}</div>
              <div className="text-sm text-neo-muted">Total Tasks</div>
            </div>
        ...
        <div className="neo-card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-neo-muted">Pending</div>
            </div>
        ...
        <div className="neo-card p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-neo-muted">Running</div>
            </div>
        ...
        <div className="neo-card p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-green-600">{taskStats.completed}</div>
              <div className="text-sm text-neo-muted">Completed</div>
            </div>
        ...
        <div className="neo-card p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-2xl font-bold text-red-600">{taskStats.failed}</div>
              <div className="text-sm text-neo-muted">Failed</div>
            </div>
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-700">
            {filteredTasks.map((task) => (
              <div key={task.id} className="p-6 neo-surface">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-neo-muted mb-3">{task.description}</p>
            ...
            {filteredTasks.length === 0 && (
              <div className="text-center py-12">
                <div className="text-neo-muted">No tasks found</div>
                <div className="text-sm text-neo-muted mt-1">
