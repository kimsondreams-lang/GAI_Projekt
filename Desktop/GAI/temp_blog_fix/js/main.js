;(function(){
  ...
  function card(a){
    ...
    return '<article class="main-article-item">'
      ...
      + (cat?('<span class="category-tag glass-badge glass-badge--primary corner-badge corner-badge--tl">'+esc(cat).toUpperCase()+'</span>'):'')
      + '</div>'
      + '<div class="article-content glass-panel p-md">'
